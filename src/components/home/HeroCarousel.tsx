...
const slides = [
  {
    id: 1,
    title: "India's Largest ADA & Aquascaping Store",
    subtitle: 'Premium Ultra Clear Tanks • ADA Substrates • Tissue Culture Plants',
    cta: 'Shop Now',
  ...
  {
    id: 2,
    title: 'Premium Hand-raised Fancy Birds',
    subtitle: 'Lovebirds • Cockatiels • Conures • Budgerigars • More',
    cta: 'Explore Birds',
  ...
  {
    id: 3,
    title: 'Complete Aquarium Equipment',
    subtitle: 'Air Pumps • Filters • CO2 Systems • Lighting • Heaters',
    cta: 'View Equipment',
