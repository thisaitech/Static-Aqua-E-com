            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4">
                <div>
                  ...
                  <input
                    ...
                    readOnly
                    placeholder="Enter MRP & Discount"
                    className="w-full px-2 py-2 sm:px-4 text-sm border border-gray-300 rounded-lg bg-gray-50 text-gray-700 cursor-not-allowed"
                  />
                </div>
